...
class SileroVadOnnxModel(modelPath: String) {
     ...
     */
    fun resetStates() {
        h = Array<Array<FloatArray?>?>(2) { Array<FloatArray?>(1) { FloatArray(64) } }
        c = Array<Array<FloatArray?>?>(2) { Array<FloatArray?>(1) { FloatArray(64) } }
        lastSr = 0
        lastBatchSize = 0
    }
    ...
    private fun validateInput(x: Array<FloatArray>, sr: Int): ValidationResult {
        ...
        if (sr != 16000 && (sr % 16000 == 0)) {
            ...
            x = reducedX as Array<FloatArray>
            sr = 16000
        }
    ...
    fun call(x: Array<FloatArray>, sr: Int): FloatArray? {
        ...
        try {
            ...
            val output = ortOutputs.get(0).getValue() as Array<FloatArray?>
            h = ortOutputs.get(1).getValue() as Array<Array<FloatArray?>?>
            c = ortOutputs.get(2).getValue() as Array<Array<FloatArray?>?>
    ...
    companion object {
        ...
        private val SAMPLE_RATES = mutableListOf<Int?>(8000, 16000)
    }
}
